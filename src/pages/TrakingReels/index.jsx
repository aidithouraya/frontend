        ...
        agents.forEach((agent, index) => {
          if (agent.id === newAgent.id && agent.status !== newAgent.status) {
            const updatedAgent = {
              ...
              statistics: newAgent.statistics,
              stateChangeTime: newAgent.stateChangeTime
            }
            setAgents(prevAgents => [
              ...prevAgents.slice(0, index),
              updatedAgent,
              ...prevAgents.slice(index + 1)
            ])
          }
        })
      })
        ...
        <div className='container box-container mt-3' id='global-position'>
          <div className='row mt-3'>
            ...
            <div className='col-lg-7 col-md-7 col-sm-6 col-xs-5 mybox'>
              <div className='box-head bb-orange'>Local transofo</div>
              <div className='box-body'>
          ...
          >
            <div className='box-4'>
              <div className='box-head'>
                ...
                <span
                  className='glyphicon glyphicon-resize-full pull-right'
                  ng-click="vm.scrollTo('callCenter')"
                ></span>
                <span
                  className='glyphicon glyphicon glyphicon-resize-small pull-right'
                  ng-click="vm.scrollTo('global-position')"
                ></span>
              </div>
              <div className='box-body'>
