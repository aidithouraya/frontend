          ...
          {agents
            ...
            .map(agent => (
              <Grid item xs={4}>
                <Card
                  sx={{ maxWidth: 345 }}
                  className={`col-lg-2 col-md-3 col-sm-4 col-xs-12 box-user ${
                    getCssStatus(agent).statusBl
                  }`}
                ...
                >
                  ...
                  <CardContent>
                    ...
                    <Typography variant='body2' color='text.secondary'>
                      <div
                        className={`status ${getCssStatus(agent).statusBg}`}
                      />

                      <div
                        className='agent-data'
                        style={{
                          display: agent.viewMode === 0 ? 'block' : 'none'
                        }}
                      >
                        <div>
                      ...
                      <div
                        className='agent-data'
                        style={{
                          display: agent.viewMode === 1 ? 'block' : 'none'
                        }}
                      >
                        <div></div>
                      </div>
